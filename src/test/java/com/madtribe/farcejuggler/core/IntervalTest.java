...
public class IntervalTest {
    ...
    @Test
    public void add_fullyInside_returnsOriginal() {
        LocalDateTime i1Start = LocalDateTime.of(2018, 12, 16, 0, 0);
        LocalDateTime i1End = LocalDateTime.of(2018, 12, 18, 0, 0);
        LocalDateTime i2Start = LocalDateTime.of(2018, 12, 17, 17, 0);
        LocalDateTime i2End = LocalDateTime.of(2018, 12, 17, 19, 0);
        Interval interval1 = new Interval(i1Start, i1End);
        Interval interval2 = new Interval(i2Start, i2End);
        ...
        assertEquals(1,retEnd.length);
        assertEquals(i1Start, retEnd[0].getStart());
        assertEquals(i1End, retEnd[0].getEnd());
    }
    ...
    @Test
    public void remove_overlappingRight_returnsShorterPeriod() {
        LocalDateTime i1Start = LocalDateTime.of(2018, 12, 16, 0, 0);
        LocalDateTime i1End = LocalDateTime.of(2018, 12, 18, 0, 0);
        LocalDateTime i2Start = LocalDateTime.of(2018, 12, 17, 23, 59);
        LocalDateTime i2End = LocalDateTime.of(2018, 12, 18, 23, 59);
        ...
        Interval[] retEnd = interval1.remove(interval2);

        assertEquals(1,retEnd.length);
        assertEquals(i1Start, retEnd[0].getStart());
        assertEquals(i2Start, retEnd[0].getEnd());
    }

    @Test
    public void remove_overlappingLeft_returnsShortingPeriod() {
        LocalDateTime i1Start = LocalDateTime.of(2018, 12, 16, 0, 0);
        LocalDateTime i1End = LocalDateTime.of(2018, 12, 18, 0, 0);
        LocalDateTime i2Start = LocalDateTime.of(2018, 12, 17, 23, 59);
        LocalDateTime i2End = LocalDateTime.of(2018, 12, 18, 23, 59);
        ...
        Interval[] retEnd = interval2.remove(interval1);

        assertEquals(1,retEnd.length);
        assertEquals(i1End, retEnd[0].getStart());
        assertEquals(i2End, retEnd[0].getEnd());
    }

    @Test
    public void remove_fullyInside_returnsTwoPeriods() {
        LocalDateTime i1Start = LocalDateTime.of(2018, 12, 16, 0, 0);
        LocalDateTime i1End = LocalDateTime.of(2018, 12, 18, 0, 0);
        LocalDateTime i2Start = LocalDateTime.of(2018, 12, 16, 12, 0);
        LocalDateTime i2End = LocalDateTime.of(2018, 12, 17, 12, 0);
        Interval interval1 = new Interval(i1Start, i1End);
        Interval interval2 = new Interval(i2Start, i2End);

        Interval[] retEnd = interval1.remove(interval2);

        assertEquals(2,retEnd.length);
        assertEquals(i1Start, retEnd[0].getStart());
        assertEquals(i2Start, retEnd[0].getEnd());

        assertEquals(i2End, retEnd[1].getStart());
        assertEquals(i1End, retEnd[1].getEnd());
    }

    @Test
    public void remove_fullyIOutside_returnsOriginal() {
        LocalDateTime i1Start = LocalDateTime.of(2018, 12, 16, 0, 0);
        LocalDateTime i1End = LocalDateTime.of(2018, 12, 18, 0, 0);
        LocalDateTime i2Start = LocalDateTime.of(2018, 12, 19, 12, 0);
        LocalDateTime i2End = LocalDateTime.of(2018, 12, 19, 14, 0);
        Interval interval1 = new Interval(i1Start, i1End);
        Interval interval2 = new Interval(i2Start, i2End);
